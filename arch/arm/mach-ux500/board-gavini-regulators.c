...
static struct regulator_consumer_supply ab8500_vaux1_consumers[] = {
	/* Proximity Sensor GP2A030 */
	REGULATOR_SUPPLY("proxvcc", "gp2a-opt"),
	REGULATOR_SUPPLY("proxvcc_00C", "gp2a-opt"),
	/* Accel BMA022 */
	...
	REGULATOR_SUPPLY("v_vdd_00C", "0-0068"),
	REGULATOR_SUPPLY("v_sensor_3v", "mmio_camera"),
};

static struct regulator_consumer_supply ab8500_vaux2_consumers[] = {
	/* Proximity Sensor GP2A030 */
	REGULATOR_SUPPLY("proxvio", "gp2a-opt"),
	REGULATOR_SUPPLY("proxvio_00C", "gp2a-opt"),
	/* Accel BMA022 */
	...
	REGULATOR_SUPPLY("v_vlogic_00C", "0-0068"),
...
static struct ab8500_regulator_reg_init
		gavini_reg_init[AB8500_NUM_REGULATOR_REGISTERS] = {
	/*
...
struct ab8500_regulator_platform_data gavini_regulator_plat_data = {
	.reg_init               = gavini_reg_init,
	.num_reg_init           = ARRAY_SIZE(gavini_reg_init),
