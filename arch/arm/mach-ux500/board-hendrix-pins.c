...
#include "board-hendrix-regulators.h"
...
static pin_cfg_t skomer_bringup_pins[] = {
	...
	GPIO75_GPIO		| PIN_OUTPUT_LOW,	/* TOUCHKEY_TEST */
	GPIO76_GPIO		| PIN_OUTPUT_LOW,	/* TOUCHKEY_RESET */
	GPIO77_GPIO		| PIN_INPUT_NOPULL,	/* TOUCHKEY_SCL */
	GPIO78_GPIO		| PIN_INPUT_NOPULL,	/* TOUCHKEY_SDA */
	GPIO79_GPIO		| PIN_INPUT_NOPULL,	/* TOUCHKEY_INT */
	...
	GPIO95_GPIO		| PIN_OUTPUT_LOW,	/* HP_MUTE */
	...
	GPIO192_GPIO		| PIN_INPUT_PULLUP,	/* KEY_CAMERA */
	...
	GPIO229_GPIO		| PIN_INPUT_PULLUP, 	/* TSP_SDA_1V8 */
	GPIO230_GPIO		| PIN_INPUT_PULLUP, 	/* TSP_SCL_1V8 */
};
...
static UX500_PINS(skomer_bringup_i2c3,
	GPIO229_I2C3_SDA |
		PIN_SLPM_GPIO | PIN_SLPM_INPUT_PULLUP,
	GPIO230_I2C3_SCL |
		PIN_SLPM_GPIO | PIN_SLPM_INPUT_PULLUP,
);
...
static struct ux500_pin_lookup skomer_bringup_lookup_pins[] = {
	...
	PIN_LOOKUP("nmk-i2c.1", &skomer_bringup_i2c1),
...
static pin_cfg_t skomer_common_sleep_table[] = {
	...
	GPIO77_GPIO | PIN_INPUT_NOPULL,	/* TOUCH_KEY_SCL */
	GPIO78_GPIO | PIN_INPUT_NOPULL,	/* TOUCH_KEY_SDA */
	GPIO79_GPIO | PIN_INPUT_PULLUP,	/* TOUCH_KEY_INT */
...
/*	GPIO138_GPIO | PIN_OUTPUT_HIGH, */
	...
	GPIO204_GPIO | PIN_INPUT_PULLUP,  /* MENU_KEY */
	GPIO205_GPIO | PIN_INPUT_PULLUP,  /* BACK_KEY */
	GPIO206_GPIO | PIN_INPUT_PULLUP,	/* ACC_INT */
	GPIO207_GPIO | PIN_INPUT_PULLDOWN,	/* NC */
...
static pin_cfg_t skomer_sleep_table[] = {
...
static void skomer_pins_suspend_force(void)
{
	...
	nmk_config_pins(skomer_sleep_table,
			ARRAY_SIZE(skomer_sleep_table));
}
