...
int cw1200_apb_write(struct CW1200_priv *priv, u32 addr, const void *buf,
		     size_t buf_len);
int cw1200_ahb_write(struct CW1200_priv *priv, u32 addr, const void *buf,
                     size_t buf_len);
...
static inline int cw1200_apb_write_32(struct CW1200_priv *priv,
				      u32 addr, u32 val)
{
...
static inline int cw1200_ahb_write_32(struct CW1200_priv *priv,
				      u32 addr, u32 val)
{
	return cw1200_ahb_write(priv, addr, &val, sizeof(val));
}
