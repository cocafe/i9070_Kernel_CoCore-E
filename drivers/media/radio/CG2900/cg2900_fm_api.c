        ...
        )
{
    ...
    result = fmd_set_bt_aup_setvolume(vol_in_percentage);
    if (0 != result) {
        FM_ERR_REPORT("cg2900_fm_set_aup_bt_setvolume: "
        ...
        )
{
    ...
    FM_INFO_REPORT("cg2900_fm_set_aup_bt_setvolume: Volume Level = %d", vol_table);
    ...
    result = fmd_set_bt_aup_setvolume_table(vol_table);
    if (0 != result) {
        FM_ERR_REPORT("cg2900_fm_set_aup_bt_setvolume: "
                "FMRSetVolume failed, err = %d",
                (unsigned int)result);
...
error:
	FM_DEBUG_REPORT("cg2900_fm_softmute_enable: returning %d",
			result);
	return result;
}
...
error:
	FM_DEBUG_REPORT("cg2900_fm_softmute_disable: returning %d",
			result);
	return result;
}
        ...
        u16 max_attenuation)
{
    ...
    FM_INFO_REPORT("cg2900_fm_softmute_setcontrol, result=%d", result);
    if (0 != result) {
        FM_ERR_REPORT("cg2900_fm_softmute_setcontrol: "
                "Failed, Error Code %d",
                (unsigned int)result);
        result = -EINVAL;
        goto error;
    ...
    error:
    FM_DEBUG_REPORT("cg2900_fm_softmute_setcontrol: returning %d",
            result);
    return result;
}
...
error:
    FM_DEBUG_REPORT("cg2900_fm_set_rssi_snr: returning %d",
            result);
    return result;
}
