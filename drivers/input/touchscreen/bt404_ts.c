...
struct tsp_cmd tsp_cmds[] = {
	...
	{TSP_CMD("run_delta_data_read", run_processed_data_read),},
	{TSP_CMD("get_reference_data", get_cal_n_data),},
	{TSP_CMD("get_scantime_count", get_cal_n_count),},
	{TSP_CMD("get_delta_data", get_processed_data),},
