/*
 * Header file for Kinetic KTD253 LED driver platform data.
 *
...
#ifndef _KTD253X_BL_H_
#define _KTD253X_BL_H_

#define BL_DRIVER_NAME_KTD253	"pri_bl_ktd253"

struct ktd253x_bl_platform_data {
	const char *bl_name;
...
/* WARNING:
	...
	in function ktd253_set_brightness().
*/
